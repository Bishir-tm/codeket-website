...
const HeroSectionMinimalInteractive = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center bg-base-100 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6 py-24">
        ...
        >
          Turn business challenges into seamless software solutions with our advanced AI-driven technology. We build enterprise software and SaaS platforms 3x faster, ensuring top-tier quality and precision.
        </motion.p>
...
export default HeroSectionMinimalInteractive;
