        ...
        <div className="grid grid-cols-2  items-center justify-center w-full md:grid-cols-3 lg:grid-cols-6 gap-8">
          {clientLogos.map((client, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex items-center justify-center p-3 object-fill bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-500 transition-all duration-300"
            >
              {client.logo}
            </motion.div>
          ))}
