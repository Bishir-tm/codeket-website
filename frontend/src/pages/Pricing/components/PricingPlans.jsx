...
const PricingPlans = ({ setSelectedPlan }) => {
  ...
  return (
    <div id="pricing-plans" className="py-24 px-6 bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-16 text-center bg-gradient-to-r from-blue-900/40 to-purple-900/40 p-8 rounded-2xl border border-blue-800/30"
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-block px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300"
            >
