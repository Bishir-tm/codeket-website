      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 m-8">
        ...
        <div className="flex flex-col rounded-2xl w-full xl:w-96 bg-[#ffffff] text-[#374151] shadow-xl">
          ...
          <div className="flex flex-col p-8 h-full">
            ...
            <div className="text-lg pb-12">
              Basic features. Get started completely for free.
            </div>
            ...
            <div className="flex pt-10">
              <button className="w-full bg-[#7e22ce] text-[#ffffff] font-bold text-base p-3 rounded-lg hover:bg-purple-800 active:scale-95 transition-transform transform">
        ...
        <div className="flex flex-col rounded-2xl w-full xl:w-96 bg-[#ffffff] text-[#374151] shadow-xl">
          ...
          <div className="flex flex-col p-8 h-full">
            ...
            <div className="text-lg pb-12">
              Exclusive features and priority support for businesses.
            </div>
            <div className="flex flex-col gap-3 text-base">
              <div className="flex flex-row gap-3">
                <div className="text-green-600">
